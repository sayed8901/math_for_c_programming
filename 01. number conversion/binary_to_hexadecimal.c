...
int main()
{
    ...
    printf("Hexadecimal number of binary %lld is: ", n);
    ...
    for (int i = 30 - 1; i >= 0; i--)
    {
        if (remainder_ar[i] != 0)
        {
            ...
            if (remainder_ar[i] == 111)
                printf("%d", 7);
            if (remainder_ar[i] == 1000)
                printf("%d", 8);
            if (remainder_ar[i] == 1001)
                printf("%d", 9);
            if (remainder_ar[i] == 1010)
                printf("%c", 'A');
            if (remainder_ar[i] == 1011)
                printf("%c", 'B');
            if (remainder_ar[i] == 1100)
                printf("%c", 'C');
            if (remainder_ar[i] == 1101)
                printf("%c", 'D');
            if (remainder_ar[i] == 1110)
                printf("%c", 'E');
            if (remainder_ar[i] == 1111)
                printf("%c", 'F');
        }
    }
